...
const routes = [
  ...
  { path: '/agents/:agentName', component: () => import('@/views/AgentDetailView.vue') },
  { path: '/agent/skills/:agentName', component: () => import('@/views/AgentSkillsView.vue') },
  ...
  { path: '/scheduler', component: () => import('@/views/TimerView.vue') },
