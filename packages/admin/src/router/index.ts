...
const routes = [
  ...
  { path: '/insight-profiles', component: () => import('@/views/automation/InsightProfilesView.vue') },
  { path: '/agenda-profiles', component: () => import('@/views/automation/AgendaProfilesView.vue') },
