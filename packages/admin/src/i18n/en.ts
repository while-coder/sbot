export default {
  ...
  heartbeats: {
    ...
    end_hour: 'End (hour)',
    timezone: 'Timezone',
    okToken: 'Empty Response Token',
    okToken_hint: 'Agent replies with this token when idle; triggers history pruning',
    pruneOk: 'Prune Empty Responses',
    dedupHours: 'Dedup Window (hours)',
    next_run: 'Next Run',
