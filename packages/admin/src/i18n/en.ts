export default {
  ...
  agents: {
    ...
    insight_prompt_file_placeholder: 'Select a prompt file',
    insight_prompt_file_hint: 'Select a prompt file from insight/extractor/ directory',
    error_insight_prompt_file: 'An extraction prompt file is required when Insight is enabled',
