export default {
  ...
  agents: {
    ...
    compact_model_placeholder: 'No auto-compact if not set',
  ...
  heartbeats: {
    ...
    name: 'Name',
    expr: 'Schedule',
    expr_hint: 'Cron expression (e.g. "0 0/30 * * *") or duration ("30m", "2h")',
    ...
    end_hour: 'End (hour)',
    timezone: 'Timezone',
    pruneIdle: 'Prune Idle Conversations',
    pruneIdle_hint: 'When enabled, clears conversation history from idle heartbeat rounds',
    status: 'Status',
    running: 'Running',
    last_run: 'Last Run',
    next_run: 'Next Run',
