export default {
  ...
  channels: {
    ...
    use_channel_memories_hint: 'When enabled, merge the memories configured on the channel',
    use_channel_wikis: 'Use channel wikis',
    use_channel_wikis_hint: 'When enabled, merge the wikis configured on the channel',
  ...
  agents: {
    ...
    compact_prompt_placeholder: 'Custom compact instruction (leave empty for default)',
