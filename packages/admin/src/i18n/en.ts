export default {
  ...
  channels: {
    ...
    tools_hint: 'Select tools allowed for daily conversations. Leave empty to allow all',
    heartbeat_tools: 'Heartbeat Tool Whitelist',
    heartbeat_tools_hint: 'Select tools available during heartbeat. Leave empty to allow all',
