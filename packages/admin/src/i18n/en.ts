export default {
  ...
  memories: {
    ...
    empty: 'No snippet knowledge configured',
    add_title: 'Add Snippet Knowledge',
    ...
    items: 'items',
    name_placeholder: 'e.g. default',
    confirm_delete: 'Delete snippet knowledge "{name}"?',
    error_embedding: 'Please select an Embedding model',
    content_title: 'Knowledge Content',
    count: '{count} items',
    add_memory: '+ Add Entry',
    clear_all: 'Clear All',
    content_col: 'Content',
    created_col: 'Created',
    access_count_col: 'Access Count',
    last_accessed_col: 'Last Accessed',
    no_memories: 'No knowledge entries',
    add_memory_title: 'Add Entry',
    edit_memory_title: 'Edit Entry',
    memory_content: 'Content',
    memory_placeholder: 'Enter knowledge content to add...',
