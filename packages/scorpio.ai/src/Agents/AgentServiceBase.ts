 ...
 *
 * @param taskId 该 think 对应的子会话 id（若有），供前端在 think / task 视图间切换。
 */
export type OnCreateThinkFn = (taskId?: string) => Promise<void>;
...
/**
 * Agent 服务基类
 * 仅保留所有 Agent 共用的最小状态：saver、logger 和系统提示词管理。
