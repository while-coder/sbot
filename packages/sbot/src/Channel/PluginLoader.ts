...
const BUILTIN_PLUGINS = ["channel.lark", "channel.slack", "channel.wecom", "channel.wechat", "channel.onebot", "channel.xiaoai", "channel.dingtalk", "channel.qq", "channel.yuanbao", "channel.remote-agent"];
