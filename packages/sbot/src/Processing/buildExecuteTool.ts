import { ChatToolCall, ToolApproval, DISPATCH_TASK_TOOL_NAME, READ_SKILL_FILE_TOOL_NAME, EXECUTE_SKILL_SCRIPT_TOOL_NAME, LIST_SKILL_FILES_TOOL_NAME, NOTE_SEARCH_TOOL_NAME, WIKI_SEARCH_TOOL_NAME, WIKI_READ_TOOL_NAME, AGENDA_CREATE_TOOL_NAME, AGENDA_LIST_TOOL_NAME, AGENDA_GET_TOOL_NAME, AGENDA_EDIT_TOOL_NAME, AGENDA_CLOSE_TOOL_NAME, AGENDA_WIKI_TOOL_NAME } from "scorpio.ai";
