 ...
 * 依赖 packages/backend/plugins/channel/channel.remote-agent/dist 已构建；没构建就跳过（不视为失败）。
 */
...
let server;
try {
  server = require("../../../backend/plugins/channel/channel.remote-agent/dist/index.js");
} catch (error) {
