...
import { WebChatEventType, WsCommandType, type WebChatEvent } from '@sbot/shared';
  ...
  private handleCmd(method: string, args: any[]): void {
    ...
    switch (method) {
      ...
      case 'disconnect':
        break;
      case 'sendMessage':
        client.sendMessage(args[0], args[1], args[2], this.isLocalServer ? this.getWorkspaceFolder() : undefined);
        break;
