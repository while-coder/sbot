...
import { DEFAULT_PORT, WsCommandType, WebChatEventType, type Settings, type WebChatEvent } from '@sbot/shared';

export { DEFAULT_PORT, type WebChatEvent } from '@sbot/shared';
