...
需要 sbot 开一个 `remote-agent` 通道，详见 [channel.remote-agent 的 README](../channel.remote-agent/README.md)。
...
[src/protocol.ts](src/protocol.ts) 是 sbot 侧 [channel.remote-agent/src/protocol.ts](../channel.remote-agent/src/protocol.ts)
